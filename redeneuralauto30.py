...
rede.setLayerSizes(np.array([10000,5000,100,10,1])) #  Acertos: 7 | Erros: 3
#rede.setLayerSizes(np.array([10000,4000,100,10,1])) #  Acertos: 7 | Erros: 3 G
#rede.setLayerSizes(np.array([10000,3000,100,10,1])) #  Acertos: 7 | Erros: 3 G
#rede.setLayerSizes(np.array([10000,2000,100,10,1])) #  Acertos: 7 | Erros: 3 G
#rede.setLayerSizes(np.array([10000,1000,100,10,1])) #  Acertos: 7 | Erros: 3
#rede.setLayerSizes(np.array([10000,500,100,10,1]))  #  Acertos: 7 | Erros: 3 G
#rede.setLayerSizes(np.array([10000,250,100,10,1]))  #  Acertos: 7 | Erros: 3 G
#rede.setLayerSizes(np.array([10000,100,100,10,1]))  #  Acertos: 7 | Erros: 3 G
